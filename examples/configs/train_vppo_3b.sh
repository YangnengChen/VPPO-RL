...
EXP_NAME="perc${top_p_perception_tokens}_advsc${advantage_scaling_min}_pen${entropy_penalty_coef}_ep${TOTAL_EPOCHES}_rollout${rollout}_MINI_ROLLOUT_BATCH_SIZE${MINI_ROLLOUT_BATCH_SIZE}"
